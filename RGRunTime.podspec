...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
			object-c runtime convenient method.
                   DESC

  s.homepage     = "https://github.com/RengeRenge/RGRunTime"
  ...
  s.source       = { :git => "https://github.com/RengeRenge/RGRunTime.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "RGRunTime", "RGRunTime/**/*.{h,m}"
